<div class="flex md:flex-row flex-col items-center md:justify-between py-8 mt-20 border-t">
	<div class="flex items-center flex-none">
		Powered by <a href="https://openai.com/" target="_blank" class="mx-1 font-bold hover:underline"
			>OpenAI</a
		>
		and
	...
	<div class="flex items-center mt-2 md:mt-0">
		<a class="group" aria-label="TaxPal on Twitter" href="https://twitter.com/steph_dietz_"
			><svg aria-hidden="true" class="mr-4 h-6 w-6 fill-slate-500 group-hover:fill-slate-700"
				><path
				...
				/></svg
			></a
		><a class="group" aria-label="TaxPal on GitHub" href="https://github.com/StephDietz/watch-this"
